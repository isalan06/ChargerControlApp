...
## 問題描述
1. 偶爾發生換上去的電池不是最有電的，這還沒抓到怎麼讓這件事觸發的
2. 上電後好像不會自己讀所有的電池狀態，全部都需要手動initial，這個需要改成上電後自動讀

## 處理方案
1. 多做一個保持充飽電再重新送電時的狀態保持
2. 確認要交換的電池前...做一個Log....來判斷交換錢電池的狀態
3. 平常要在判斷的話...可以做一個timer定期去判斷
