...
namespace ChargerControlApp.Hardware
{
    public class NPB450Controller
    {
        ...
        */
        ...
        //    
        //}
        public NPB450Controller(ChargingStationStateMachine stateMachine, ICANBusService canBusService)
        {
        ...
        //{
        //    byte[] VoltageBytes = await GetStatusFromDeviceAsync(NPB1700Controller.CanbusReadCommand.READ_VOUT);
        //    ushort Voltage = BitConverter.ToUInt16(new byte[] { VoltageBytes[2], VoltageBytes[3] }.ToArray(), 0);
        //    return (double)Voltage / 100;
        //}
        ...
        private byte[] GetStatusFromDevice2(CanbusReadCommand command)
        {
            ...
            _canBusService.SendCommand(sendBytes);
