...
namespace ChargerControlApp.DataAccess.Modbus.Models
{
    public class ModbusRTUFrame
    {
        ...
        public void Set(byte slaveAddress, byte functionCode, ushort startAddress, ushort dataNumber, ushort[] data)
        {
        ...
        {
            Set(frame.SlaveAddress, frame.FunctionCode, frame.StartAddress, frame.DataNumber, frame.Data);
        }
    }
}
